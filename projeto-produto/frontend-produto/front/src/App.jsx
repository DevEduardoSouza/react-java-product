...
function App() {
  ...
  return (
    <>
      <Formulario botao={btnCadastra} evento={aoDigitar} cadastrar={cadastrar} error={error} obj={objProduto} cancelar={limparFormulario} remover={remover}  alterar={alterar}/>
